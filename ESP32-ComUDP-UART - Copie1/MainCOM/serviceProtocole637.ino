...
void serviceProtocole637_attendUneRequete(void)
{
  ...
  piloteUART_transmet(SERVICEPROTOCOLE637_DEBUT_DE_TRAME);
...
for(int i = 0; i < SERVICEPROTOCOLE637_NOMBRE_DE_DONNEES_MAXIMUM; i++)
  ...
  piloteUART_transmet(serviceProtocole637.nombreATransmettre);
...
unsigned char donnee ;
  ...
  piloteUART_transmet(serviceProtocole637.octetsATransmettre[serviceProtocole637_compteurDeTransmissions]);
...
void serviceProtocole637_transmetUnZero(void)
{
 ...
 piloteUART_transmet(SERVICEPROTOCOLE637_INSERTION);
...
piloteUART_transmet(serviceProtocole637_checksumDeTransmission);
...
unsigned char serviceProtocole637_gereUneReception(void)
{
  if (piloteUART_octetDisponible() == PILOTEUART_PAS_DISPONIBLE)
  {
    return SERVICEPROTOCOLE637_LECTURE_PAS_DISPONIBLE;
  }
  serviceProtocole637_reception = piloteUART_litUnOctetRecu();
  //piloteUART_confirmeLaReception();
