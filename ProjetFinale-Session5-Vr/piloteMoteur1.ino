...
{
  ledcWrite(piloteMoteur1_EN_BROCHE, Niveau);
}

void piloteMoteur1_IN1_metA(unsigned char Niveau)
{
  ledcWrite(piloteMoteur1_IN1_BROCHE, Niveau);
}

void piloteMoteur1_IN2_metA(unsigned char Niveau)
{
  ledcWrite(piloteMoteur1_IN2_BROCHE, Niveau);
}
...
#ifdef piloteMoteur1_ETAT_INITIAL_A_UN
ledcWrite(piloteMoteur1_EN_BROCHE, 1); // Sortie PWM (LED), duty cycle Ã  0	
#endif
